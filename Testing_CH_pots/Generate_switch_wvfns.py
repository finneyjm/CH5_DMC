...
def lets_get_these_wvfns(type, switch_speed):
    if type == 'min':
        ...
        plt.plot(grid, np.mean(GSW[0], axis=0)/np.linalg.norm(np.mean(GSW[0], axis=0)), color='orange', label='Average')
        plt.plot(grid, GSW[0, 2, :], color='green', label=r'CH$_3$')
        plt.plot(grid, GSW[0, 4, :], color='red', label=r'CH$_5$')
        # plt.plot(grid, GSW[0, 0, :], color='blue', label=r'CH$_1$')
        # plt.plot(grid, GSW[0, 1, :], color='purple', label=r'CH$_2$')
        # plt.plot(grid, GSW[0, 2, :], color='green', label=r'CH$_3$')
        # plt.plot(grid, GSW[0, 3, :], color='teal', label=r'CH$_4$')
        # plt.plot(grid, GSW[0, 4, :], color='red', label=r'CH$_5$')
        # plt.plot(grid, GSW[0, 4, :], label='Higher Frequency CH stretch')
        plt.xlabel(r'r$_{\rm{CH}_{\it{i}}}$ (Angstrom)', fontsize=22)
        plt.ylabel('Probability Amplitude', fontsize=22)
        ...
        plt.plot(grid, GSW[1, 0, :], color='blue', label=r'CH$_1$')
        plt.plot(grid, GSW[1, 1, :], color='purple', label=r'CH$_2$')
        plt.plot(grid, GSW[1, 2, :], color='green', label=r'CH$_3$')
        plt.plot(grid, GSW[1, 3, :], color='teal', label=r'CH$_4$')
        plt.plot(grid, GSW[1, 4, :], color='red', label=r'CH$_5$')
        # plt.plot(grid, GSW[0, 4, :], label='Higher Frequency CH stretch')
        plt.xlabel(r'r$_{\rm{CH}_{\it{i}}}$ (Angstrom)', fontsize=22)
        plt.ylabel('Probability Amplitude', fontsize=22)
        ...
        # plt.plot(grid, GSW[1, 2, :], color='green', label=r'CH$_3$')
        # plt.plot(grid, GSW[1, 4, :], color='red', label=r'CH$_5$')
        plt.plot(grid, GSW[2, 0, :], color='blue', label=r'CH$_1$')
        plt.plot(grid, GSW[2, 1, :], color='purple', label=r'CH$_2$')
        plt.plot(grid, GSW[2, 2, :], color='green', label=r'CH$_3$')
        plt.plot(grid, GSW[2, 3, :], color='teal', label=r'CH$_4$')
        plt.plot(grid, GSW[2, 4, :], color='red', label=r'CH$_5$')
        # plt.plot(grid, GSW[0, 4, :], label='Higher Frequency CH stretch')
        plt.xlabel(r'r$_{\rm{CH}_{\it{i}}}$ (Angstrom)', fontsize=22)
        plt.ylabel('Probability Amplitude', fontsize=22)
        plt.tick_params(axis='both', which='major', labelsize=16)

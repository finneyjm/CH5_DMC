...
def lets_get_some_energies(non_imp_samp_walkers, imp_samp_walkers, trials_ni, trials_i, isotop):
    ...
    # axes[0].plot(non_imp_samp_walkers, [ens[isotop]] * len(non_imp_samp_walkers), color='purple', label="Anne's Value", linestyle='--')
...
# lets_get_some_energies(walkers68, walkers89, 5, 5, 5)
# plt.show()

# blah = np.load(f'Trial_wvfn_testing/results/ptetramer_non_imp_samp/' +

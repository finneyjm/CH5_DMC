...
for a, b in zip(size, s):
    with open(f'DMC_Non_imp_sampled_pdimer_{a}.sh', 'w') as myfile:
        myfile.write('#!/bin/bash\n\n')
        myfile.write('## Job Name\n\n')
        myfile.write(f'#SBATCH --job-name=Non_imp_sampled_pdimer_{b}\n\n')
        ...
        myfile.write(f'python Non_imp_sampled_pdimer_subproc_{a}.py\n')
        ...
        myfile.write(f'echo "Non_imp_sampled_pdimer_{b} took: $DIFF"')

...
for a, b in zip(size, s):
    with open(f'DMC_imp_sampled_discrete_analytic_5H_ts_1_{a}.sh', 'w') as myfile:
        myfile.write('#!/bin/bash\n\n')
        myfile.write('## Job Name\n\n')
        myfile.write(f'#SBATCH --job-name=Imp_sampled_disc_analytic_5H_ts_1_{b}\n\n')
        ...
        myfile.write(f'#SBATCH -o check_imp_sampled_disc_analytic_5H_ts_1_{b}.dat\n\n')
        ...
        myfile.write(f'echo "Imp_sampled_disc_analytic_5H_ts_1_{b} took: $DIFF"')

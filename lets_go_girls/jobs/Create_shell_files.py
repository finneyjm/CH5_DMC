...
for a, b in zip(size, s):
    with open(f'DMC_Non_imp_sampled_CD.sh', 'w') as myfile:
        myfile.write('#!/bin/bash\n\n')
        myfile.write('## Job Name\n\n')
        myfile.write(f'#SBATCH --job-name=Non_imp_sampled_CD_{b}\n\n')
        ...
        myfile.write(f'python Non_imp_sampled_CD_subproc_{a}.py\n')

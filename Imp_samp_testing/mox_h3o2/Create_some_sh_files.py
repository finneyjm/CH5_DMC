...
for i in range(10):
    for type_of_sim in sim:
        with open(f'DMC_h3o2_chb2_{type_of_sim}_{i+1}.sh', 'w') as myfile:
            ...
            myfile.write('#SBATCH --time=0-20:00:00\n\n')
            ...
            myfile.write(f'python chain_rule_h3o2_dmc_new_drift_biggest_{type_of_sim}_{i + 1}_param.py\n')
